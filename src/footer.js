        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <hr className="mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px", backgroundColor: "#7c4dff", height: "2px" }} />
              <p><i className="bi bi-house-door me-2"></i> New York, NY 10012, US</p>
              <p><i className="bi bi-envelope me-2"></i> info@example.com</p>
              <p><i className="bi bi-telephone me-2"></i> + 01 234 567 88</p>
              <p><i className="bi bi-printer me-2"></i> + 01 234 567 89</p>
            </div>
          </div>
        </div>
      </section> */}
      <div className="text-center p-3" style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}>
        © 2024 Yeagerist. All Rights Reserved.
      </div>
    </footer>
  );
};
